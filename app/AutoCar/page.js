          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            <Card className="bg-white dark:bg-gray-800">
              <img
                ...
                height="200"
                src="/images/20240123_010225.jpg"
                style={{
                  aspectRatio: "200/200",
                  objectFit: "cover",
                }}
            ...
            <Card className="bg-white dark:bg-gray-800">
              <img
                ...
                className="w-full h-100 object-cover"
                height="200"
                src="/images/IMG_20230818_223651.jpg"
                style={{
                  aspectRatio: "200/200",
                  objectFit: "cover",
                }}
          ...
          <div className="mt-10">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">
              ...
              <img
                ...
                src="/images/AutoCar/AutoCarDocs-1.png"
                style={{
              ...
              <img
                ...
                src="/images/AutoCar/AutoCarDocs-2.png"
                style={{
              ...
              <img
                ...
                src="/images/AutoCar/AutoCarDocs-3.png"
                style={{
              ...
              <img
                ...
                src="/images/AutoCar/AutoCarDocs-4.png"
                style={{
              ...
              <img
                ...
                src="/images/AutoCar/AutoCarDocs-5.png"
                style={{
              ...
              <img
                ...
                src="/images/AutoCar/AutoCarDocs-6.png"
                style={{
